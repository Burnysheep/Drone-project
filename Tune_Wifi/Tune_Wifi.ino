...
// const char* password = "qwerty@3103";
// const char* host = "192.168.1.122";
// const int port = 8080;

const char* ssid = "Active 1";
const char* password = "31032003";
const char* host = "192.168.193.9";
const int port = 8080;

// const char* ssid = "Exam";
// const char* password = "thi@0904";
// const char* host = "172.16.102.109";
// const int port = 8080;
